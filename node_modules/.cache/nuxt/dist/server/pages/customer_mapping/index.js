  ...
  methods: {
    ...
    async searchDT() {
      ...
      if (this.dtSearchQuery == '') {
        ...
        this.hideSearchBtn = true;
        let responseSearch = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* getDTSearch */ "i"])(this.dtSearchQuery);
    ...
    async doSomethingWithFilesimagePickerForBuilding(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.account_number, 'CustomerMapping_Building', this.pic_of_building);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
