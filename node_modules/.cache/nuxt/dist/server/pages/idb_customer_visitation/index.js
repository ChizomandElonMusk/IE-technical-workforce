  ...
  methods: {
    ...
    async checkNumber() {
      if (this.service_type == 'prepaid') {
        ...
        try {
          const response = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* getIDBCustomerInfoApi */ "n"])(this.meter_number);
          this.account_type = '';
          this.account_name = '';
          this.tarrif = '';
          this.address = '';
    ...
    async doSomethingWithFilesimagePickerForIDBbox(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.meter_number, 'IdbValidation_IdbBox', this.pic_of_idb_box);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForTerminationPoint(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.meter_number, 'IdbValidation_TerminationPoint', this.pic_of_termination_point);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForMeter(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.meter_number, 'IdbValidation_Meter', this.pic_of_meter);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForShowingIDBMeterNo(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.meter_number, 'IdbValidation_ShowingIdbMeterNo', this.pic_showing_idb_meter_no);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
