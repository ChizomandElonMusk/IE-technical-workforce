  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForWireDown(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.account_number, 'CustomerDetails_WireDown', this.pic_of_wire_down);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForCFV(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.account_number, 'CustomerDetails_FrontView', this.pic_of_fv);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
