...
var customer_visitationvue_type_script_lang_js = __webpack_require__(60);
...
installComponents(component, {CustomSelect: __webpack_require__(45).default})
...
/* harmony import */ var _js_modules_mods__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(46);
/* harmony import */ var _components_CustomSelect_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(45);
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForPremises(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerVisitation_Premise', this.pic_of_premise);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForAdditionalPic(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerVisitation_Additional', this.pic_of_additional_pic);
        console.log(xx);
        if (this.random_id != '') {
          this.account_number = '';
        }
    ...
    async doSomethingWithFilesimagePickerForPaymentReceipt(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerVisitation_PaymentReceipt', this.pic_of_payment_receipt);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForMeter(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerVisitation_Meters', this.pic_of_meter);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
