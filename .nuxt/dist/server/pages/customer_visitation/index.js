...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
      ...
      if (this.service_type == 'prepaid') {
        ...
        try {
          if (this.meter_number == '') {
            ...
            let response = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* getCustomerInfoApi2 */ "g"])(this.meter_number, 'Prepaid');
            console.log(response);
    ...
    async getCustomerInfo(accountNumber) {
      try {
        let response = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* getCustomerInfoApi2 */ "g"])(accountNumber, 'Postpaid');
        console.log(response);
    ...
    async doSomethingWithFilesimagePickerForPremises(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.account_number2, 'CustomerVisitation_Premise', this.pic_of_premise);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForAdditionalPic(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.account_number2, 'CustomerVisitation_Additional', this.pic_of_additional_pic);
        console.log(xx);
        if (this.random_id != '') {
          this.account_number = '';
        }
    ...
    async doSomethingWithFilesimagePickerForPaymentReceipt(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.account_number2, 'CustomerVisitation_PaymentReceipt', this.pic_of_payment_receipt);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForMeter(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "u"])(this.userId, this.account_number2, 'CustomerVisitation_Meters', this.pic_of_meter);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async printCurrentPosition() {
      const {
        long,
        lat
      } = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* getCurrentPosition */ "e"])();
      this.long = long;
      this.lat = lat;
