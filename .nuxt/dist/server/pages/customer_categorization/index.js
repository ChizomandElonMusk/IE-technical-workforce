...
var customer_categorizationvue_type_script_lang_js = __webpack_require__(56);
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForRYB(event) {
      ...
      try {
        ...
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerCat_RYB', this.pic_of_the_ryb);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForNSinglePhase(event) {
      ...
      try {
        ...
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerCat_Neutral', this.pic_of_the_n);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForBuildingSinglePhase(event) {
      ...
      try {
        ...
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerCat_Building', this.pic_of_the_buidling);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForRThreePhase(event) {
      ...
      try {
        ...
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerCat_Red', this.pic_of_the_r_threephase);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForYThreePhase(event) {
      ...
      try {
        ...
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerCat_Yellow', this.pic_of_the_y_threephase);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForBThreePhase(event) {
      ...
      try {
        ...
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number2, 'CustomerCat_Blue', this.pic_of_the_b_threephase);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
