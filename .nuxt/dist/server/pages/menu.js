...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/menu.vue?vue&type=template&id=4d2f7e6a&scoped=true
var render = function render() {
  ...
  }, [_vm._ssrNode("<div class=\"row\" data-v-4d2f7e6a><div class=\"col s12\" data-v-4d2f7e6a><b class=\"red white-text btn\" data-v-4d2f7e6a><i class=\"material-icons\" data-v-4d2f7e6a>lock</i></b> <b class=\"grey-text btn disabled\" data-v-4d2f7e6a>Work Order</b></div></div> "), !_vm.hidePreLoader ? _c('PreLoader') : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"row\" data-v-4d2f7e6a>", "</div>", [_vm._ssrNode("<div class=\"row\" data-v-4d2f7e6a>", "</div>", [_vm._ssrNode("<div class=\"col s12 center\" data-v-4d2f7e6a>", "</div>", _vm._l(_vm.work_order, function (value) {
    return _vm._ssrNode("<div class=\"card-panel white-text left-align\" style=\"background: linear-gradient(to right, #E75309, #C60606); padding: 15px; border-radius: 10px;\" data-v-4d2f7e6a>", "</div>", [_vm._ssrNode("<span class=\"yellow-text\" data-v-4d2f7e6a><h6 data-v-4d2f7e6a><b class=\"white-text\" data-v-4d2f7e6a>" + _vm._ssrEscape(_vm._s(value.faultDescription)) + "</b> <br data-v-4d2f7e6a>" + _vm._ssrEscape("\n              " + _vm._s(value.workOrder) + "\n\n            ") + "</h6></span> <hr style=\"color: #fff;\" data-v-4d2f7e6a> <br data-v-4d2f7e6a> <p style=\"margin-top: -10px;\" data-v-4d2f7e6a><b data-v-4d2f7e6a>" + _vm._ssrEscape("Feeder Band: " + _vm._s(value.feederBand)) + "</b></p> <br data-v-4d2f7e6a> <p style=\"margin-top: -30px;\" data-v-4d2f7e6a>\n            Status: <b class=\"yellow-text\" data-v-4d2f7e6a>" + _vm._ssrEscape("\n              " + _vm._s(value.status) + "\n            ") + "</b></p> <br data-v-4d2f7e6a> <p style=\"margin-top: -30px;\" data-v-4d2f7e6a>\n            Created on: <b class=\"white-text\" data-v-4d2f7e6a>" + _vm._ssrEscape("\n              " + _vm._s(_vm.formatDate(value.dateEntered)) + "\n            ") + "</b></p> "), _c('nuxt-link', {
...
// CONCATENATED MODULE: ./pages/menu.vue?vue&type=template&id=4d2f7e6a&scoped=true
