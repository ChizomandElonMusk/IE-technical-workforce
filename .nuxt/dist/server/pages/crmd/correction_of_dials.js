...
var correction_of_dialsvue_type_script_lang_js = __webpack_require__(79);
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForFVSNOD(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number, 'CorrectionOfDials_FrontView', this.pic_of_frontview);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
