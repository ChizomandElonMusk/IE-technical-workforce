...
var switch_to_dormantvue_type_script_lang_js = __webpack_require__(82);
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForEvidence(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number, 'SwitchToDormant_Evidence', this.pic_of_evidence);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
