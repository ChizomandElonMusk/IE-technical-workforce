...
var switch_to_quantitativevue_type_script_lang_js = __webpack_require__(82);
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForFBNM(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number, 'SwitchToQuantitative_Faulty', this.pic_of_fbnm);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerAdditionalPic1(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number, 'SwitchToQuantitative_Additional', this.additional_pic1);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerAdditionalPic2(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number, 'SwitchToQuantitative_Additional1', this.additional_pic2);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
