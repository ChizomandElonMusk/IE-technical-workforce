...
var account_reactivationvue_type_script_lang_js = __webpack_require__(77);
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForPictureOfConnection(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number, 'AccountReactivation_Connection', this.pic_of_connection);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForPictureOfPSF(event) {
      ...
      try {
        ...
        // console.log('pic_of_connection ', this.pic_of_connection)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number, 'AccountReactivation_FrontView', this.pic_of_psf);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForPictureOfEnergyBalance(event) {
      ...
      try {
        ...
        // console.log('pic_of_connection ', this.pic_of_connection)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number, 'AccountReactivation_EnergyBalance', this.pic_of_energy_balance);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
