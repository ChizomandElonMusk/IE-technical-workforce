...
var correction_of_lar_parvue_type_script_lang_js = __webpack_require__(80);
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForPAR(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number, 'CorrectionOfLarPar_FrontView', this.pic_of_frontview);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerAdditionalPic(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number, 'CorrectionOfLarPar_Additional', this.pic_of_additional_pic);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
