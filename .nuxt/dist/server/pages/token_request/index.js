...
var token_requestvue_type_script_lang_js = __webpack_require__(73);
  ...
  methods: {
    ...
    async checkNumber() {
      if (this.service_type == 'prepaid') {
        ...
        try {
          const response = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* checkCustomerMeterNumber */ "c"])(this.meter_number);
    ...
    async getCustomerInfo(accountNumber) {
      try {
        let response = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* getCustomerInfoApi */ "g"])(accountNumber);
        console.log(response);
    ...
    async getRequestDetails() {
      try {
        let response = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* getRequestDetailsWithTrackingId */ "r"])(this.tracking_id);
        console.log(response);
        await this.printCurrentPosition();
    ...
    async doSomethingWithFilesimagePickerForMeter(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number, 'TokenRequest_Meter', this.pic_of_meter);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForMeterInstallationPoint(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number, 'TokenRequest_MeterInstPoint', this.pic_of_meter_installation_point);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForBuilding(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number, 'TokenRequest_Building', this.pic_of_building);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForSeal(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number, 'TokenRequest_Seal', this.pic_of_seal);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
