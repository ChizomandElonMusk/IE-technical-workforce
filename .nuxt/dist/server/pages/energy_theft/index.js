...
var energy_theftvue_type_script_lang_js = __webpack_require__(61);
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForAdditionalPic2(event) {
      ...
      try {
        ...
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number2, 'EnergyTheft_Additional1', this.pic_of_additional_pic2);
        console.log(xx);
    ...
    async doSomethingWithFilesimagePickerForTheft(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number2, 'EnergyTheft_Theft', this.pic_of_theft);
        console.log(xx);
        if (this.random_id != '') {
          this.account_number = '';
        }
    ...
    async doSomethingWithFilesimagePickerForBypass(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number2, 'EnergyTheft_ByPass', this.pic_of_bypass);
        console.log(xx);
    ...
    async doSomethingWithFilesimagePickerForAdditional(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number2, 'EnergyTheft_Additional', this.pic_of_additional);
        console.log(xx);
    ...
    async doSomethingWithFilesimagePickerForMeter(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "x"])(this.userId, this.account_number2, 'EnergyTheft_Meter', this.pic_of_meter);
        console.log(xx);
