...
var idb_customer_mappingvue_type_script_lang_js = __webpack_require__(64);
  ...
  methods: {
    ...
    async doSomethingWithFilesimagePickerForIDBbox(event) {
      ...
      try {
        ...
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number, 'CustomerIdbBoxMapping_IdbBox', this.pic_of_the_customer_idb_box_mapping_idb_box);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
    ...
    async doSomethingWithFilesimagePickerForIDBmeterTemplate(event) {
      ...
      try {
        ...
        // console.log('pic_of_cwd ', this.pic_of_cwd)
        // hello()
        var xx = await Object(_js_modules_mods__WEBPACK_IMPORTED_MODULE_3__[/* uploadImage */ "y"])(this.userId, this.account_number, 'CustomerIdbBoxMapping_ShowingIdbMeterNo', this.pic_of_the_customer_idb_mapping_shoing_idb_meter_no);
        console.log(xx);
      } catch (error) {
        // // console.log(error);
      }
